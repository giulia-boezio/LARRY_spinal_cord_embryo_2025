...
#Get file name
file_names = ["preprocessing_larry_chicken.h5ad" , "preprocessing_larry_chicken_progenitors.h5ad" , "preprocessing_larry_chicken_neurons.h5ad"]

file_names = ["preprocessing_larry_chicken_progenitors.h5ad" , "preprocessing_larry_chicken_neurons.h5ad"]

file_names = ["preprocessing_larry_chicken_progenitors_no_RP_FP.h5ad"]
...
for file_name in file_names:
    ...
    #Only cells are kept that express between a 2000 and 6000 genes
    cell_genes = np.sum(adata_counts > 0,axis=1)
    keep_cells = np.where((cell_genes > 2000) & (cell_genes < 6000))[0]
